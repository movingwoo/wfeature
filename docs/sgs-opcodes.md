...
| `0xe7` | `0x0041d6c0` | P | Seven words: (1,1,sourceResource,destinationResource,frameIndex,unused,unused). Extract type-1 literal/coded SIS frames with exact references and reference tile replacements into a resource; other composition modes, type 2 and SAF remain unsupported. See [extended images](sgs-images.md). |
