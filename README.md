...
게임에서 문자 입력칸을 선택한 뒤 **Opts → 🔤 문자 입력**을 누르면 폰·PC 기본 쿼티 키보드와 한글 IME로 입력할 수 있습니다. 창을 열면 입력 가능 여부와 안내가 표시됩니다. 한글 조합을 마치고 **입력**을 누르면 게임에 반영됩니다. 기존 글자 뒤에 추가하는 입력칸에서는 **삽입**으로 표시됩니다.
