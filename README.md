...
게임에서 문자 입력칸을 선택한 뒤 설정의 **문자 입력**을 누르면 폰·PC 기본 키보드로 입력할 수 있습니다. 한글 조합을 마치고 **입력**을 누르면 게임에 반영됩니다. KTF·SKT의 지원되는 입력칸에서 사용할 수 있으며, 게임이 직접 그린 입력창과 LGT 입력창은 아직 지원하지 않습니다.
