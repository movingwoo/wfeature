...
- **📱 화면** — 게임에게 알려줄 단말 화면입니다. 기본은 240×320이고 게임마다
  따로 기억하며, 바꾸면 다음 실행부터 적용됩니다. 화면을 크게 **보이게** 하는
  설정이 아닙니다 — 그건 🔍 화질과 브라우저 확대입니다. 240×320보다 작은 둘은
  작은 단말용으로 나온 게임을 위한 것이고, 큰 둘(240×400 · 320×480)은 후기
  피쳐폰 화면입니다. 넓어진 자리를 게임이 쓸지는 게임에 달려 있어서, 화면을
  넓게 잡고 그리는 게임이 있는가 하면 원래 크기 그대로 왼쪽 위에 그리고 나머지를
  검게 두는 게임도 있고, 드물게 자기가 가정한 크기를 넘겨 멈추는 게임도 있습니다.
  이상하면 240×320으로 되돌리면 됩니다.
