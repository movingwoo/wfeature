...
func stringBufferDefinition() ClassDefinition {
	...
	return ClassDefinition{
		...
		Methods: []MethodDefinition{
			...
			{Name: "deleteCharAt", Descriptor: "(I)Ljava/lang/StringBuffer;", Access: native},
			{Name: "getChars", Descriptor: "(II[CI)V", Access: native},
...
func stringBuilderDefinition() ClassDefinition {
	...
	return ClassDefinition{
		...
		Methods: []MethodDefinition{
			...
			{Name: "deleteCharAt", Descriptor: "(I)Ljava/lang/StringBuilder;", Access: native},
			{Name: "getChars", Descriptor: "(II[CI)V", Access: native},
...
func threadDefinition() ClassDefinition {
	return ClassDefinition{
		...
		Methods: []MethodDefinition{
			...
			{Name: "activeCount", Descriptor: "()I", Access: AccessPublic | AccessStatic | AccessNative},
