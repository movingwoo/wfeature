...
/**
 * The MIDP 2.0 HTTP connection. No implementation of it is ever handed out:
 * every Connector.open is refused, so this interface exists to be named. A
 * game that declares a field of this type, or catches on it, resolves the
 * name instead of meeting the class loader's "class not found", which is a
 * host error rather than something guest code can catch.
 */
